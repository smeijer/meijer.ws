...
function AvatarContainer({ className, ...props }: JSX.IntrinsicElements['div']) {
  return (
    <div
      className={clsx(
        className,
...
function Avatar({ large = false, className, ...props }: { large?: boolean, className?: string, style?: CSSProperties }) {
  return (
    <Link
      href="/"
      aria-label="Home"
