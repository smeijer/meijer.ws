...
tags: webdev, node, development, pm2
date: 2021-03-21
---

Do you recognize that scenario were starting a project in dev mode, requires multiple actions to be taken? I think we all have or had those cases. Start a local database, start a node app, and maybe even start some file watchers to watch and compile css files or other assets.
